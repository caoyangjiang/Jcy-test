...
NVENCSTATUS CNvHWEncoder::NvEncOpenEncodeSession(void* device,
                                                 uint32_t deviceType)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;

  nvStatus =
      m_pEncodeAPI->nvEncOpenEncodeSession(device, deviceType, &m_hEncoder);
...
NVENCSTATUS CNvHWEncoder::NvEncGetEncodeProfileGUIDCount(
    GUID encodeGUID, uint32_t* encodeProfileGUIDCount)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;

  nvStatus = m_pEncodeAPI->nvEncGetEncodeProfileGUIDCount(
      m_hEncoder, encodeGUID, encodeProfileGUIDCount);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
  }
                                                     ...
                                                     uint32_t* GUIDCount)
{
  ...
  nvStatus = m_pEncodeAPI->nvEncGetEncodeProfileGUIDs(
      m_hEncoder, encodeGUID, profileGUIDs, guidArraySize, GUIDCount);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
  }
                                              ...
                                              uint32_t* GUIDCount)
{
  ...
  nvStatus = m_pEncodeAPI->nvEncGetEncodeGUIDs(
      m_hEncoder, GUIDs, guidArraySize, GUIDCount);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
  }
...
NVENCSTATUS CNvHWEncoder::NvEncGetInputFormatCount(GUID encodeGUID,
                                               ...
                                               uint32_t* inputFmtCount)
{
  ...
  nvStatus = m_pEncodeAPI->nvEncGetInputFormats(
      m_hEncoder, encodeGUID, inputFmts, inputFmtArraySize, inputFmtCount);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
  }
                                             ...
                                             int* capsVal)
{
  ...
  nvStatus = m_pEncodeAPI->nvEncGetEncodeCaps(
      m_hEncoder, encodeGUID, capsParam, capsVal);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
  }
...
NVENCSTATUS CNvHWEncoder::NvEncGetEncodePresetCount(
...
NVENCSTATUS CNvHWEncoder::NvEncGetEncodePresetGUIDs(
    GUID encodeGUID,
    GUID* presetGUIDs,
    uint32_t guidArraySize,
...
NVENCSTATUS CNvHWEncoder::NvEncGetEncodePresetConfig(
...
NVENCSTATUS CNvHWEncoder::NvEncCreateInputBuffer(
    uint32_t width,
    uint32_t height,
    void** inputBuffer,
    NV_ENC_BUFFER_FORMAT inputFormat)
{
  ...
  nvStatus = m_pEncodeAPI->nvEncCreateInputBuffer(m_hEncoder,
...
NVENCSTATUS CNvHWEncoder::NvEncCreateMVBuffer(uint32_t size,
...
NVENCSTATUS CNvHWEncoder::NvEncDestroyMVBuffer(
...
NVENCSTATUS CNvHWEncoder::NvRunMotionEstimationOnly(
    MotionEstimationBuffer* pMEBuffer, MEOnlyConfig* pMEOnly)
{
  ...
  nvStatus =
      m_pEncodeAPI->nvEncRunMotionEstimationOnly(m_hEncoder, &stMEOnlyParams);
  return nvStatus;
}

NVENCSTATUS CNvHWEncoder::NvEncCreateBitstreamBuffer(uint32_t size,
                                                     void** bitstreamBuffer)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;
...
NVENCSTATUS CNvHWEncoder::NvEncDestroyBitstreamBuffer(
    NV_ENC_OUTPUT_PTR bitstreamBuffer)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;
  ...
  {
    nvStatus =
        m_pEncodeAPI->nvEncDestroyBitstreamBuffer(m_hEncoder, bitstreamBuffer);
    if (nvStatus != NV_ENC_SUCCESS)
    {
      assert(0);
    }
...
NVENCSTATUS CNvHWEncoder::NvEncLockBitstream(
    NV_ENC_LOCK_BITSTREAM* lockBitstreamBufferParams)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;

  nvStatus =
      m_pEncodeAPI->nvEncLockBitstream(m_hEncoder, lockBitstreamBufferParams);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
  }
...
NVENCSTATUS CNvHWEncoder::NvEncUnlockBitstream(
    NV_ENC_OUTPUT_PTR bitstreamBuffer)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;
                                               ...
                                               uint32_t* pitch)
{
  ...
  nvStatus =
      m_pEncodeAPI->nvEncLockInputBuffer(m_hEncoder, &lockInputBufferParams);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
  }
    ...
    NV_ENC_SEQUENCE_PARAM_PAYLOAD* sequenceParamPayload)
{
  ...
  nvStatus =
      m_pEncodeAPI->nvEncGetSequenceParams(m_hEncoder, sequenceParamPayload);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
  }
...
NVENCSTATUS CNvHWEncoder::NvEncUnregisterAsyncEvent(void* completionEvent)
{
  ...
  if (completionEvent)
  {
    ...
    nvStatus =
        m_pEncodeAPI->nvEncUnregisterAsyncEvent(m_hEncoder, &eventParams);
    if (nvStatus != NV_ENC_SUCCESS)
    {
      assert(0);
    }
...
NVENCSTATUS CNvHWEncoder::NvEncMapInputResource(void* registeredResource,
                                                void** mappedResource)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;
  ...
  nvStatus =
      m_pEncodeAPI->nvEncMapInputResource(m_hEncoder, &mapInputResParams);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
  }
...
NVENCSTATUS CNvHWEncoder::NvEncUnmapInputResource(
    NV_ENC_INPUT_PTR mappedInputBuffer)
{
  ...
  {
    nvStatus =
        m_pEncodeAPI->nvEncUnmapInputResource(m_hEncoder, mappedInputBuffer);
    if (nvStatus != NV_ENC_SUCCESS)
    {
      assert(0);
    }
...
NVENCSTATUS CNvHWEncoder::NvEncInvalidateRefFrames(
    const NvEncPictureCommand* pEncPicCommand)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;

  for (uint32_t i = 0; i < pEncPicCommand->numRefFramesToInvalidate; i++)
  {
    nvStatus = m_pEncodeAPI->nvEncInvalidateRefFrames(
        m_hEncoder, pEncPicCommand->refFrameNumbers[i]);
  }

  return nvStatus;
}

NVENCSTATUS CNvHWEncoder::NvEncOpenEncodeSessionEx(
    void* device, NV_ENC_DEVICE_TYPE deviceType)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;
  ...
  nvStatus =
      m_pEncodeAPI->nvEncOpenEncodeSessionEx(&openSessionExParams, &m_hEncoder);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
  }
...
NVENCSTATUS CNvHWEncoder::NvEncRegisterResource(
    ...
    void** registeredResource)
{
  ...
  nvStatus =
      m_pEncodeAPI->nvEncRegisterResource(m_hEncoder, &registerResParams);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
  }
...
NVENCSTATUS CNvHWEncoder::NvEncUnregisterResource(
...
NVENCSTATUS CNvHWEncoder::NvEncReconfigureEncoder(
    const NvEncPictureCommand* pEncPicCommand)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;

  if (pEncPicCommand->bBitrateChangePending ||
      pEncPicCommand->bResolutionChangePending)
  {
    ...
    stReconfigParams.forceIDR =
        pEncPicCommand->bResolutionChangePending ? 1 : 0;

    nvStatus =
        m_pEncodeAPI->nvEncReconfigureEncoder(m_hEncoder, &stReconfigParams);
    if (nvStatus != NV_ENC_SUCCESS)
    {
      assert(0);
    }
...
NVENCSTATUS CNvHWEncoder::ValidateEncodeGUID(GUID inputCodecGuid)
{
  ...
  nvStatus            = m_pEncodeAPI->nvEncGetEncodeGUIDs(
      m_hEncoder, encodeGUIDArray, encodeGUIDCount, &encodeGUIDArraySize);
  if (nvStatus != NV_ENC_SUCCESS)
  {
...
NVENCSTATUS CNvHWEncoder::ValidatePresetGUID(GUID inputPresetGuid,
                                             GUID inputCodecGuid)
{
  ...
  nvStatus = m_pEncodeAPI->nvEncGetEncodePresetCount(
      m_hEncoder, inputCodecGuid, &presetGUIDCount);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    assert(0);
    return nvStatus;
...
NVENCSTATUS CNvHWEncoder::CreateEncoder(EncodeConfig* pEncCfg)
{
  ...
  m_uMaxHeight =
      (pEncCfg->maxHeight > 0 ? pEncCfg->maxHeight : pEncCfg->height);
  ...
  if ((pEncCfg->inputFormat == NV_ENC_BUFFER_FORMAT_YUV420_10BIT ||
       pEncCfg->inputFormat == NV_ENC_BUFFER_FORMAT_YUV444_10BIT) &&
      (pEncCfg->codec == NV_ENC_H264))
  {
  ...
  if (pEncCfg->bitrate || pEncCfg->vbvMaxBitrate)
  {
    m_stEncodeConfig.rcParams.rateControlMode =
        (NV_ENC_PARAMS_RC_MODE)pEncCfg->rcMode;
  ...
  if (pEncCfg->rcMode == NV_ENC_PARAMS_RC_VBR ||
      pEncCfg->rcMode == NV_ENC_PARAMS_RC_VBR_MINQP ||
      pEncCfg->rcMode == NV_ENC_PARAMS_RC_2_PASS_VBR)
  {
    ...
    if (pEncCfg->i_quant_factor != 0.0 && pEncCfg->b_quant_factor != 0.0)
    {
      m_stEncodeConfig.rcParams.initialRCQP.qpIntra =
          (int)(pEncCfg->qp * FABS(pEncCfg->i_quant_factor) +
                pEncCfg->i_quant_offset);
      m_stEncodeConfig.rcParams.initialRCQP.qpInterB =
          (int)(pEncCfg->qp * FABS(pEncCfg->b_quant_factor) +
                pEncCfg->b_quant_offset);
    }
    else
    {
  ...
  if (pEncCfg->inputFormat == NV_ENC_BUFFER_FORMAT_YUV444 ||
      pEncCfg->inputFormat == NV_ENC_BUFFER_FORMAT_YUV444_10BIT)
  {
  ...
  m_pEncodeAPI->nvEncGetEncodeCaps(
      m_hEncoder, m_stCreateEncodeParams.encodeGUID, &stCapsParam, &asyncMode);
  ...
  if (pEncCfg->enableMEOnly == 1 || pEncCfg->enableMEOnly == 2)
  {
    ...
    int meonlyMode                          = 0;
    nvStatus =
        m_pEncodeAPI->nvEncGetEncodeCaps(m_hEncoder,
                                         m_stCreateEncodeParams.encodeGUID,
                                         &stCapsParam,
                                         &meonlyMode);
    if (nvStatus != NV_ENC_SUCCESS)
  ...
  nvStatus =
      m_pEncodeAPI->nvEncInitializeEncoder(m_hEncoder, &m_stCreateEncodeParams);
  if (nvStatus != NV_ENC_SUCCESS)
  {
    PRINTERR("Encode Session Initialization failed");
    return nvStatus;
...
GUID CNvHWEncoder::GetPresetGUID(char* encoderPreset, int codec)
{
  ...
  {
    if (encoderPreset) PRINTERR("Unsupported preset guid %s\n", encoderPreset);
    presetGUID = NV_ENC_PRESET_DEFAULT_GUID;
  }

  GUID inputCodecGUID =
      codec == NV_ENC_H264 ? NV_ENC_CODEC_H264_GUID : NV_ENC_CODEC_HEVC_GUID;
...
NVENCSTATUS CNvHWEncoder::ProcessOutput(const EncodeBuffer* pEncodeBuffer)
{
  ...
  if (pEncodeBuffer->stOutputBfr.bEOSFlag) return NV_ENC_SUCCESS;
  ...
  if (nvStatus == NV_ENC_SUCCESS)
  {
    ...
    nvStatus = m_pEncodeAPI->nvEncUnlockBitstream(
        m_hEncoder, pEncodeBuffer->stOutputBfr.hBitstreamBuffer);
  }
  else
  {
...
NVENCSTATUS CNvHWEncoder::ProcessMVOutput(
    const MotionEstimationBuffer* pMEBuffer)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;

  if (pMEBuffer->stOutputBfr.hBitstreamBuffer == NULL &&
      pMEBuffer->stOutputBfr.bEOSFlag == FALSE)
  {
    return NV_ENC_ERR_INVALID_PARAM;
  }
  ...
  if (pMEBuffer->stOutputBfr.bEOSFlag) return NV_ENC_SUCCESS;
  ...
  if (nvStatus == NV_ENC_SUCCESS)
  {
    ...
    {
      unsigned int numMBs =
          ((m_uMaxWidth + 15) >> 4) * ((m_uMaxHeight + 15) >> 4);
      fprintf(m_fOutput,
              "Motion Vectors for input frame = %d, reference frame = %d\n",
              pMEBuffer->inputFrameIndex,
              pMEBuffer->referenceFrameIndex);
      fprintf(m_fOutput,
              "block, mb_type, partitionType, "
              "MV[0].x, MV[0].y, MV[1].x, MV[1].y, MV[2].x, MV[2].y, MV[3].x, "
              "MV[3].y, cost\n");
      NV_ENC_H264_MV_DATA* outputMV =
          (NV_ENC_H264_MV_DATA*)lockBitstreamData.bitstreamBufferPtr;
    ...
    {
      unsigned int numCTBs =
          ((m_uMaxWidth + 31) >> 5) * ((m_uMaxHeight + 31) >> 5);
      fprintf(m_fOutput,
              "Motion Vectors for input frame = %d, reference frame = %d\n",
              pMEBuffer->inputFrameIndex,
              pMEBuffer->referenceFrameIndex);
      NV_ENC_HEVC_MV_DATA* outputMV =
          (NV_ENC_HEVC_MV_DATA*)lockBitstreamData.bitstreamBufferPtr;
      fprintf(m_fOutput,
              "ctb, cuType, cuSize, partitionMode, "
              "MV[0].x, MV[0].y, MV[1].x, MV[1].y, MV[2].x, MV[2].y, MV[3].x, "
              "MV[3].y\n");
    ...
    nvStatus = m_pEncodeAPI->nvEncUnlockBitstream(
        m_hEncoder, pMEBuffer->stOutputBfr.hBitstreamBuffer);
  }
  else
  {
    PRINTERR("lock bitstream function failed \n");
...
NVENCSTATUS CNvHWEncoder::Initialize(void* device,
                                     NV_ENC_DEVICE_TYPE deviceType)
{
  NVENCSTATUS nvStatus = NV_ENC_SUCCESS;
  MYPROC nvEncodeAPICreateInstance;  // function pointer to create instance in
                                     // nvEncodeAPI
...
#endif
  if (m_hinstLib == NULL) return NV_ENC_ERR_OUT_OF_MEMORY;
...
#else
  nvEncodeAPICreateInstance =
      (MYPROC)dlsym(m_hinstLib, "NvEncodeAPICreateInstance");
#endif

  if (nvEncodeAPICreateInstance == NULL) return NV_ENC_ERR_OUT_OF_MEMORY;

  m_pEncodeAPI = new NV_ENCODE_API_FUNCTION_LIST;
  if (m_pEncodeAPI == NULL) return NV_ENC_ERR_OUT_OF_MEMORY;
...
NVENCSTATUS CNvHWEncoder::ParseArguments(EncodeConfig* encodeConfig,
                                         int argc,
                                         char* argv[])
{
  for (int i = 1; i < argc; i++)
  {
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%d", &encodeConfig->vbvMaxBitrate) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%d", &encodeConfig->startFrameIdx) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%f", &encodeConfig->i_quant_factor) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%f", &encodeConfig->b_quant_factor) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%f", &encodeConfig->i_quant_offset) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%f", &encodeConfig->b_quant_offset) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%d", &encodeConfig->intraRefreshEnableFlag) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%d", &encodeConfig->intraRefreshPeriod) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%d", &encodeConfig->intraRefreshDuration) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%d", &encodeConfig->pictureStruct) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    else if (stricmp(argv[i], "-inputFormat") == 0)
    {
      ...
      NV_ENC_BUFFER_FORMAT aFormatTable[] = {NV_ENC_BUFFER_FORMAT_NV12,
                                             NV_ENC_BUFFER_FORMAT_YUV444,
                                             NV_ENC_BUFFER_FORMAT_YUV420_10BIT,
                                             NV_ENC_BUFFER_FORMAT_YUV444_10BIT};
      if (++i >= argc || sscanf(argv[i], "%d", &inputFormatIndex) != 1 ||
          inputFormatIndex < 0 ||
          inputFormatIndex >= (sizeof(aFormatTable) / sizeof(aFormatTable[0])))
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%d", &encodeConfig->enableMEOnly) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%d", &encodeConfig->preloadedFrameCount) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }
    ...
    {
      if (++i >= argc ||
          sscanf(argv[i], "%d", &encodeConfig->enableTemporalAQ) != 1)
      {
        PRINTERR("invalid parameter for %s\n", argv[i - 1]);
        return NV_ENC_ERR_INVALID_PARAM;
      }

...
class CNvHWEncoder
{
 ...
 public:
  ...
  NVENCSTATUS NvRunMotionEstimationOnly(MotionEstimationBuffer* pMEBuffer,
  ...
  NVENCSTATUS NvEncInvalidateRefFrames(
  ...
  NVENCSTATUS NvEncReconfigureEncoder(
      const NvEncPictureCommand* pEncPicCommand);
  ...
  static NVENCSTATUS ParseArguments(EncodeConfig* encodeConfig,
                                    int argc,
                                    char* argv[]);
};
